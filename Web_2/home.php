...
<body>
	...
	?>
		...
		<form action="gallery.php" method="get" class="botan">
	...
	<?php
		...
		echo "<img src=".$array["message"]." alt=/>";
		
	?>
		<form action="gallery3.php" method="get" class="botan">
	...
	<?php
		...
		//CatAPIを用いてjsonデータをダウンロードする
		$json= file_get_contents($req);
		$array = json_decode($json , true );
		echo "<img src=".$array["file"]." alt=/>";
	?>


		<form action="gallery4.php" method="get" class="botan">
