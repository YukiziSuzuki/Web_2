...
<?php
   ...
   $state_kana = $xml->ADDRESS_value->value[0]->attributes()->state_kana;
   $city_kana = $xml->ADDRESS_value->value[1]->attributes()->city_kana; 
   $address_kana = $xml->ADDRESS_value->value[2]->attributes()->address_kana; 
   $company_kana = $xml->ADDRESS_value->value[3]->attributes()->company_kana; 
   $state = $xml->ADDRESS_value->value[4]->attributes()->state; 
   $city = $xml->ADDRESS_value->value[5]->attributes()->city;
   $address = $xml->ADDRESS_value->value[6]->attributes()->address;
   $company = $xml->ADDRESS_value->value[7]->attributes()->company;
